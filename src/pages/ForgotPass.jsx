          ...
          <form >
            ...
            <div className='flex justify-between whitespace-nowrap test-sm sm:text-lg'>
              <p className='mb-6 text-white'>Don't have an account?
                <Link to="/sign_up" className='text-red-600 hover:red-700 transition duration-200 ease-in-out ml-1'>Register</Link>
              </p>
              <p>
                <Link to="/sign_in" className='text-blue-600 hover:text-blue-700 transition duration-200 ease-in-out'>Sign In</Link>
              </p>
            </div>
